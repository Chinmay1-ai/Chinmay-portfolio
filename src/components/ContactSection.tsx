...
export default function ContactSection() {
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                               href="mailto:pawarchinmay92@gmail.com"
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        {/* Instagram */}
                        <a
                           href="https://www.instagram.com/_chinmaypawar/"
                            target="_blank"
                            rel="noopener noreferrer"
...
{/* LinkedIn */}
<a
  href="https://www.linkedin.com/in/chinmay-pawar1004/"
  target="_blank"
  rel="noopener noreferrer"
  aria-label="LinkedIn"
  className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
...
>
  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-blue-400/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
